...
function App() {
  ...
  return (
    <div className="min-h-screen p-6 md:p-12 flex flex-col items-center relative font-sans overflow-hidden">
      ...
      <footer className="mt-auto py-8 w-full text-center space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-1000 delay-500">
        {/* Social Links */}
        <div className="flex justify-center items-center gap-6">
          <a href="https://github.com/CodeWithBasu" target="_blank" rel="noopener noreferrer" className="text-secondary hover:text-primary hover:scale-110 transition-all duration-300">
          ...
          <a href="https://www.linkedin.com/in/basudev-moharana" target="_blank" rel="noopener noreferrer" className="text-secondary hover:text-primary hover:scale-110 transition-all duration-300">
             <span className="sr-only">LinkedIn</span>
             <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
               <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd" />
             </svg>
          </a>
          <a href="https://www.instagram.com/wandersoul________?igsh=MTR2dDJua2NpeHI5Yw==" target="_blank" rel="noopener noreferrer" className="text-secondary hover:text-primary hover:scale-110 transition-all duration-300">
        ...
        <div className="pt-2 border-t border-white/5 w-full max-w-xs mx-auto">
             <p className="text-[10px] text-secondary/40">System v3.1 &bull; Signal Ready</p>
        </div>
      </footer>
    </div>
  );
